    ...
    public function generateTimetable($classe, array $study_days, array &$schedule = []): bool
{
    ...
    public function findAvailableProf(string $day, string $heure_debut, string $heure_fin, $contraintes, array $schedule,$matiere): ?Professeurs
    {
                        ...
                        switch ($index) {
                            case 0:
                                if($heure_debut=="07:30"&& $heure_fin == "09:00"){
                                    ...
                                    if (!$this->isProfBusy($contrainte->getProfesseur()->getId(), $day, $heure_debut, $heure_fin, $schedule,$matiere)) {
                                        return $contrainte->getProfesseur();
                                    }
                                }
                                break;
    ...
    public function isProfBusy(int $prof_id, string $day, string $heure_debut, string $heure_fin, array $schedule,$matiere): bool
    {
